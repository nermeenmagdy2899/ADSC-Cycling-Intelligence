    ...
    <header className="app-header fixed left-0 right-0 top-0 z-50 px-4 py-3">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <button className="rounded-md border border-white/10 bg-white/10 px-3 py-2 text-sm font-semibold text-pearl transition hover:border-palm/60 hover:bg-palm/20" aria-label="Toggle language" onClick={toggleLanguage}>
            {languageLabel}
          </button>
